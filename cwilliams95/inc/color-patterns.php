 ...
 */
function cwilliams95_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'cwilliams95_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.cwilliams95-front-page) .entry-title,
...
.colors-custom .cwilliams95-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.cwilliams95-front-page .panel-content .recent-posts article,
...
.colors-custom.cwilliams95-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'cwilliams95_custom_colors_css', $css, $hue, $saturation );
}
